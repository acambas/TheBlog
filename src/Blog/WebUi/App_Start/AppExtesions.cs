...
{
    public static class AppHtmlExtesions
    {
        public static IHtmlString JsonSerialize(this HtmlHelper htmlHelper, object value)
        {
            return htmlHelper.Raw(Json.Encode(value));
        }
    }
